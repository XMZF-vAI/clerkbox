...
# ClerkBox Skill Installation Script
# Downloads, validates, and installs a skill package from a ZIP URL.
# Usage: install-skill.sh --name <skillName> --url <downloadUrl> [--target-dir <dir>]

# ─── Defaults ───────────────────────────────────────────────────────────────────
TARGET_DIR="${HOME}/.clerkbox/skills"
NAME=""
URL=""
...
Options:
  ...
  --target-dir  (optional) Installation target directory. Default: ~/.clerkbox/skills
